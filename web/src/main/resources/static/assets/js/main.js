(function (a) {
    ...
    a(document).ready(function () {
        ...
        a("body").each(function () {
            a(this).find(".img-pop").magnificPopup({type: "image", gallery: {enabled: true}})
        });
        new WOW().init();
        a(".faq-wrapper .faq-title").on("click", function (l) {
            ...
            if (m.hasClass("open")) {
                ...
                m.siblings(".faq-item").children(".faq-content").slideUp(300, "swing");
                m.siblings(".faq-item").removeClass("open");
                m.siblings(".faq-item").find(".faq-title, .faq-title-two").removeClass("open");
                m.siblings(".faq-item").find(".faq-content").slideUp(300, "swing")
            }
        });
        ...
        a("ul>li>.submenu").parent("li").addClass("menu-item-has-children");
        a("ul").parent("li").hover(function () {
        ...
        a(".menu li a").on("click", function (l) {
            ...
            if (m.hasClass("open")) {
                ...
                m.siblings("li").children("ul").slideUp(300, "swing");
                m.siblings("li").removeClass("open");
                m.siblings("li").find("li").removeClass("open");
                m.siblings("li").find("ul").slideUp(300, "swing")
            }
        });
        var k = a(".scrollToTop");
        ...
        a(".tab ul.tab-menu li").on("click", function (l) {
            var n = a(this).closest(".tab"), m = a(this).closest("li").index();
            n.find("li").siblings("li").removeClass("active");
            a(this).closest("li").addClass("active");
            n.find(".tab-area").find("div.tab-item").not("div.tab-item:eq(" + m + ")").fadeOut(500);
            n.find(".tab-area").find("div.tab-item:eq(" + m + ")").fadeIn(500);
            l.preventDefault()
        });
        a(".search-tab ul.tab-menu li").on("click", function (l) {
            var m = a(this).closest(".search-tab"), n = a(this).closest("li").index();
            m.find("li").siblings("li").removeClass("active");
            a(this).closest("li").addClass("active");
            m.find(".tab-area").find("div.tab-item").not("div.tab-item:eq(" + n + ")").hide(10);
            m.find(".tab-area").find("div.tab-item:eq(" + n + ")").show(10);
            l.preventDefault()
        });
        a(".tabTwo ul.tab-menu li").on("click", function (l) {
            var n = a(this).closest(".tabTwo"), m = a(this).closest("li").index();
            n.find("li").siblings("li").removeClass("active");
            a(this).closest("li").addClass("active");
            n.find(".tab-area").find("div.tab-item").not("div.tab-item:eq(" + m + ")").fadeOut(10);
            n.find(".tab-area").find("div.tab-item:eq(" + m + ")").fadeIn(10);
            l.preventDefault()
        });
        a(".counter-item").each(function () {
            a(this).isInViewport(function (n) {
                if (n === "entered") {
                    for (var m = 0; m < document.querySelectorAll(".odometer").length; m++) {
        ...
        a(".social-icons li a").on("mouseover", function (l) {
            ...
            if (m.children("a").hasClass("active")) {
                m.siblings("li").children("a").removeClass("active");
                a(this).addClass("active")
            } else {
                m.siblings("li").children("a").removeClass("active");
                a(this).addClass("active")
        ...
        a(".seat-free img").on("click", function (l) {
            if (b == 0) {
                ...
                if (b == 1) {
                    a(this).attr("src", "./assets/images/movie/seat01-booked.png");
                    b = 0
                }
            }
        });
        ...
        a(".countdown").countdown({date: "10/15/2022 05:00:00", offset: +2, day: "Day", days: "Days"}, function () {
            alert("Done!")
        });
